...
async def get_orders(
    ...
    try:
        ...
        # Get orders from repository with filters
        orders = await order_service.order_repository.get_orders_with_filters(
            filters=filters,
            skip=skip,
            limit=limit
        )
        ...
        total_count = await order_service.order_repository.count_orders_with_filters(filters)
