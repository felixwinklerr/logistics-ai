...
Revision ID: ba704e2550e7
Revises: 
Create Date: 2025-07-24 08:43:24.889687
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk_subcontractors'))
    )
    op.create_index(op.f('ix_subcontractors_company_name'), 'subcontractors', ['company_name'], unique=False)
    op.create_index(op.f('ix_subcontractors_email'), 'subcontractors', ['email'], unique=False)
    op.create_index(op.f('ix_subcontractors_id'), 'subcontractors', ['id'], unique=False)
    op.create_index(op.f('ix_subcontractors_is_active'), 'subcontractors', ['is_active'], unique=False)
    op.create_index(op.f('ix_subcontractors_vat_number'), 'subcontractors', ['vat_number'], unique=True)
    ...
    sa.Column('phone', sa.String(length=50), nullable=True),
    sa.Column('role', sa.Enum('ADMIN', 'DISPATCHER', 'ACCOUNTANT', 'VIEWER', name='userrole'), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('client_vat_number', sa.String(length=50), nullable=False),
    sa.Column('client_contact_email', sa.String(length=255), nullable=True),
    sa.Column('client_payment_terms', sa.String(length=100), nullable=False),
    sa.Column('client_offered_price', sa.Numeric(precision=10, scale=2), nullable=False),
    sa.Column('pickup_address', sa.Text(), nullable=False),
    sa.Column('pickup_postcode', sa.String(length=20), nullable=True),
    sa.Column('pickup_city', sa.String(length=100), nullable=True),
    sa.Column('pickup_country', sa.String(length=2), nullable=False),
    ...
    sa.Column('pickup_date_start', sa.Date(), nullable=True),
    sa.Column('pickup_date_end', sa.Date(), nullable=True),
    ...
    sa.Column('delivery_coordinates', geoalchemy2.types.Geography(geometry_type='POINT', srid=4326, from_text='ST_GeogFromText', name='geography'), nullable=True),
    sa.Column('delivery_date_start', sa.Date(), nullable=True),
    sa.Column('delivery_date_end', sa.Date(), nullable=True),
    sa.Column('cargo_ldm', sa.Numeric(precision=5, scale=2), nullable=True),
    sa.Column('cargo_weight_kg', sa.Numeric(precision=8, scale=2), nullable=True),
    sa.Column('cargo_pallets', sa.Integer(), nullable=True),
    sa.Column('cargo_description', sa.Text(), nullable=True),
    sa.Column('special_requirements', sa.Text(), nullable=True),
    sa.Column('subcontractor_id', sa.UUID(), nullable=True),
    sa.Column('subcontractor_price', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('subcontractor_payment_terms', sa.String(length=100), nullable=True),
    sa.Column('truck_plate', sa.String(length=20), nullable=True),
    ...
    sa.Column('order_status', sa.Enum('PENDING', 'ASSIGNED', 'IN_TRANSIT', 'AWAITING_DOCUMENTS', 'DOCUMENTS_RECEIVED', 'DOCUMENTS_VALIDATED', 'CLIENT_INVOICED', 'PAYMENT_RECEIVED', 'SUBCONTRACTOR_PAID', 'COMPLETED', 'CANCELLED', 'DISPUTED', name='orderstatus'), nullable=False),
    sa.Column('uit_code', sa.String(length=50), nullable=True),
    sa.Column('original_pdf_path', sa.String(length=500), nullable=True),
    sa.Column('generated_order_pdf_path', sa.String(length=500), nullable=True),
    sa.Column('invoice_pdf_path', sa.String(length=500), nullable=True),
    sa.Column('pod_pdf_path', sa.String(length=500), nullable=True),
    ...
    sa.Column('notes', sa.Text(), nullable=True),
    sa.Column('client_reference_number', sa.String(length=100), nullable=True),
    sa.ForeignKeyConstraint(['subcontractor_id'], ['subcontractors.id'], name=op.f('fk_orders_subcontractor_id_subcontractors')),
    ...
    op.create_index('idx_orders_pickup_coordinates', 'orders', ['pickup_coordinates'], unique=False, postgresql_using='gist')
    op.create_index(op.f('ix_orders_client_company_name'), 'orders', ['client_company_name'], unique=False)
    op.create_index(op.f('ix_orders_client_offered_price'), 'orders', ['client_offered_price'], unique=False)
    op.create_index(op.f('ix_orders_client_vat_number'), 'orders', ['client_vat_number'], unique=False)
    op.create_index(op.f('ix_orders_delivery_city'), 'orders', ['delivery_city'], unique=False)
    op.create_index(op.f('ix_orders_delivery_postcode'), 'orders', ['delivery_postcode'], unique=False)
    ...
    op.create_index(op.f('ix_orders_pickup_city'), 'orders', ['pickup_city'], unique=False)
    op.create_index(op.f('ix_orders_pickup_postcode'), 'orders', ['pickup_postcode'], unique=False)
    op.create_index(op.f('ix_orders_subcontractor_id'), 'orders', ['subcontractor_id'], unique=False)
    op.create_index(op.f('ix_orders_uit_code'), 'orders', ['uit_code'], unique=True)
    op.create_table('document_validations',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('order_id', sa.UUID(), nullable=False),
    sa.Column('document_type', sa.Enum('INVOICE', 'POD', 'TRANSPORT_ORDER', 'CLIENT_INVOICE', 'ADDITIONAL', name='documenttype'), nullable=False),
    ...
    sa.Column('is_efactura_compliant', sa.Boolean(), nullable=True),
    sa.Column('file_size_bytes', sa.Integer(), nullable=True),
    sa.Column('file_hash', sa.String(length=64), nullable=True),
    sa.Column('mime_type', sa.String(length=100), nullable=True),
    sa.Column('processed_by_user_id', sa.UUID(), nullable=True),
    sa.Column('processing_notes', sa.Text(), nullable=True),
    sa.Column('ai_extraction_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('ai_confidence_scores', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.ForeignKeyConstraint(['order_id'], ['orders.order_id'], name=op.f('fk_document_validations_order_id_orders')),
    sa.ForeignKeyConstraint(['processed_by_user_id'], ['users.id'], name=op.f('fk_document_validations_processed_by_user_id_users')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_document_validations'))
    )
    op.create_index(op.f('ix_document_validations_document_type'), 'document_validations', ['document_type'], unique=False)
    op.create_index(op.f('ix_document_validations_file_hash'), 'document_validations', ['file_hash'], unique=False)
    op.create_index(op.f('ix_document_validations_id'), 'document_validations', ['id'], unique=False)
    op.create_index(op.f('ix_document_validations_invoice_number'), 'document_validations', ['invoice_number'], unique=False)
    op.create_index(op.f('ix_document_validations_is_valid'), 'document_validations', ['is_valid'], unique=False)
    op.create_index(op.f('ix_document_validations_order_id'), 'document_validations', ['order_id'], unique=False)
    ...
    sa.Column('status', sa.Enum('RECEIVED', 'PROCESSING', 'PROCESSED', 'FAILED', 'IGNORED', name='emailstatus'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['order_id'], ['orders.order_id'], name=op.f('fk_email_records_order_id_orders')),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_document_validations_order_id'), table_name='document_validations')
    op.drop_index(op.f('ix_document_validations_is_valid'), table_name='document_validations')
    op.drop_index(op.f('ix_document_validations_invoice_number'), table_name='document_validations')
    op.drop_index(op.f('ix_document_validations_id'), table_name='document_validations')
    op.drop_index(op.f('ix_document_validations_file_hash'), table_name='document_validations')
    op.drop_index(op.f('ix_document_validations_document_type'), table_name='document_validations')
    op.drop_table('document_validations')
    op.drop_index(op.f('ix_orders_uit_code'), table_name='orders')
    op.drop_index(op.f('ix_orders_subcontractor_id'), table_name='orders')
    op.drop_index(op.f('ix_orders_pickup_postcode'), table_name='orders')
    op.drop_index(op.f('ix_orders_pickup_city'), table_name='orders')
    op.drop_index(op.f('ix_orders_order_status'), table_name='orders')
    op.drop_index(op.f('ix_orders_order_id'), table_name='orders')
    op.drop_index(op.f('ix_orders_delivery_postcode'), table_name='orders')
    op.drop_index(op.f('ix_orders_delivery_city'), table_name='orders')
    op.drop_index(op.f('ix_orders_client_vat_number'), table_name='orders')
    op.drop_index(op.f('ix_orders_client_offered_price'), table_name='orders')
    op.drop_index(op.f('ix_orders_client_company_name'), table_name='orders')
    op.drop_index('idx_orders_pickup_coordinates', table_name='orders', postgresql_using='gist')
    ...
    op.drop_table('users')
    op.drop_index(op.f('ix_subcontractors_vat_number'), table_name='subcontractors')
    op.drop_index(op.f('ix_subcontractors_is_active'), table_name='subcontractors')
    ...
    op.drop_index(op.f('ix_subcontractors_company_name'), table_name='subcontractors')
